...
FolderOut = Arguments[3];				//Path of the result folder to explor
Pathlog = Folder+File.separator()+"Analysis_log.txt";	//Path of the log file
Pathlist = FolderOut+File.separator()+"ListFiles.txt";	//Path of the file containing all identified images to be processed
